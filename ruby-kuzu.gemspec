# -*- encoding: utf-8 -*-
# stub: ruby-kuzu 0.1.0.pre.20250306154602 ruby lib
# stub: ext/kuzu_ext/extconf.rb

Gem::Specification.new do |s|
  s.name = "ruby-kuzu".freeze
  s.version = "0.1.0.pre.20250306154602".freeze
  ...
  s.files = ["History.md".freeze, "LICENSE.txt".freeze, "README.md".freeze, "ext/kuzu_ext/config.c".freeze, "ext/kuzu_ext/connection.c".freeze, "ext/kuzu_ext/database.c".freeze, "ext/kuzu_ext/extconf.rb".freeze, "ext/kuzu_ext/kuzu_ext.c".freeze, "ext/kuzu_ext/kuzu_ext.h".freeze, "ext/kuzu_ext/query_summary.c".freeze, "ext/kuzu_ext/result.c".freeze, "ext/kuzu_ext/types.c".freeze, "lib/kuzu.rb".freeze, "lib/kuzu/config.rb".freeze, "lib/kuzu/connection.rb".freeze, "lib/kuzu/database.rb".freeze, "lib/kuzu/query_summary.rb".freeze, "lib/kuzu/result.rb".freeze, "spec/kuzu/config_spec.rb".freeze, "spec/kuzu/database_spec.rb".freeze, "spec/kuzu/query_summary_spec.rb".freeze, "spec/kuzu/result_spec.rb".freeze, "spec/kuzu_spec.rb".freeze, "spec/spec_helper.rb".freeze]
